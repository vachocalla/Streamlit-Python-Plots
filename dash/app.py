...
st.title(" :bar_chart:   SuperStore Vi")
#st.markdown('<style>div.block-container{padding-top:1rem}</style>', unsafe_allow_html=True)

fl = st.file_uploader(':file:_folder: Upload a File', type=(["csv","txt","xlsx","xls"]) )
...
if fl is not None:
    ...
    os.chdir(r"C:\FL\python\streamlit\myproject\dash")
...
region =  st.sidebar.multiselect("Pick you Region", df["Region"].unique())
...
#---------------------------------------------------------------------------
# Create for City
city = st.sidebar.multiselect("Pick de City", df3["City"].unique() )

# filter de data based on Region, State and City
...
with cl1:
   with st.expander("Category_ViewData"):
        ...
        st.download_button(
            ...
            mime = "text/csv",
            help = "Click here to download de Datas as CSV file"
            )
